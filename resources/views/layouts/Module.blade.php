		...
		<div class="modal fade " id="kt_modal_create_category" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-xl ">
				<!--begin::Modal content-->
				<div class="modal-content app-content rounded">
					<!--begin::Modal header-->
					<div class="modal-header justify-content-end border-0 pb-0">
						<!--begin::Close-->
						<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20 ">
						...
						<div class="mb-13 text-center">
							...
							<div class="text-muted fw-semibold fs-5">If you need more info, please check
								<a href="{{route('product.category.list')}}" class="link-primary fw-bold">Category settings</a>.
							</div>
						</div>
						<!--end::Heading-->
						<!--begin::Plans-->
						<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
							...
							<div class="d-flex flex-column flex-column-fluid">
								...
								<div id="kt_app_content" class="app-content px-0">
									<!--begin::Form-->
									<form id="create_product_category" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data" method="post">
										@csrf
										<!--begin::Aside column-->
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="{{url()->current()}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
												<!--end::Button-->
												<!--begin::Button-->
												<button type="submit" id="create_product_category_submit" class="btn btn-primary">
		...
		<!--begin::Modal - create profile vendor-->
		<div class="modal fade" id="vendor_profile" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog mw-650px">
				<!--begin::Modal content-->
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						<!--begin::Heading-->
						<div class="text-center py-4 mb-5 border-bottom border-gray-300 border-bottom-dashed">
							<!--begin::Title-->
							<h1 class="mb-3">Update profile</h1>
							<!--end::Title-->
						</div>
						<!--end::Heading-->
						<form action="{{ route('vendor.profile') }}" method="post" enctype="multipart/form-data" autocomplete="off" id="vendorProfileForm">
							@csrf
							...
							<div class="d-flex flex-stack py-4">
								<div class="card-body pt-0">
									...
									<div class="mb-10 fv-row fv-plugins-icon-container">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" class="form-control mb-2" placeholder="First name" name="first_name" value="{{ old('first_name', $client->first_name) }}">
										<!--end::Input-->
									...
									<div class="mb-10 fv-row fv-plugins-icon-container">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" class="form-control mb-2" placeholder="Last name" name="last_name" value="{{ old('last_name', $client->last_name) }}">
										<!--end::Input-->
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
							...
							<div class="d-flex justify-content-end">
								<!--begin::Button-->
								<a href="{{ url()->current() }}" class="btn btn-light me-5">Cancel</a>
								<!--end::Button-->
								<!--begin::Button-->
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div data-kt-search>
							...
							<div data-kt-search-element="content">
								<!-- Menu or other content -->
							</div>
							<div data-kt-search-element="spinner" class="d-none">Loading...</div>
						</div>
