            ...
            <div class="item">
              <div class="explore-box">
                ...
                <div class="content">
                  ...
                  <h4 class="text-white mb-0">Mumbai</h4>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="about_wrapper position-relative" data-aos="zoom-in">
              ...
              <div class="box" data-aos="fade-up">
                ...
                <div class="text">
                  <span class="value"
                    ><span class="numb counter">156</span>+</span
                  >
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12">
            <div
              class="testimonial_wrapper position-relative"
              data-aos="zoom-in"
            >
